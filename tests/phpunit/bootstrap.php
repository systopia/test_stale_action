...
// Make CRM_TestStaleAction_ExtensionUtil available.
require_once __DIR__ . '/../../test_stale_action.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('test_stale_action');
 ...
 */
function _test_stale_action_test_civicrm_container(ContainerBuilder $container): void {
}
